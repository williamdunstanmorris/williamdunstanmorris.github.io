...
! function(e, t) {
    ...
    var A = Array.prototype.forEach,
        ...
        L = function() {
            ...
            return S.each(O, function(t) {
                if (t.litmus(e)) return S.each(t.conversions, function(t, n) {
                    if (T = t.read(e), !1 === R && !1 !== T) return R = T, T.conversionName = n, T.conversion = t, S.BREAK
                }), S.BREAK
            }), R
        },
        B = void 0,
        ...
        I = function() {
            function e() {
                if (F(this, e), this.__state = L.apply(this, arguments), !1 === this.__state) throw new Error("Failed to interpret color arguments");
    ...
    var se = "Default",
        ...
        he = function e(t) {
            ...
            if (Object.defineProperties(this, {
                ...
                var l = c(n, a);
                X.addClass(this.__ul, e.CLASS_CLOSED), X.addClass(l, "title"), X.bind(l, "click", function(e) {
